...
bool renderPlayerPanel(Player& player, playedCardsType& playedCards, const std::string& currentPlayer, bool justShow);
...
int main() {
    ...
    while (!done)
    {
        ...
        // Main loop
        {
                ...
                for (auto& player : players) {
                    if (renderPlayerPanel(player, playedCards, currentPlayer, handCompleted)) {
